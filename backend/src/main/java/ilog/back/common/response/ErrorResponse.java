package ilog.back.common.response;

import ilog.back.common.exception.ErrorCode;
...
public record ErrorResponse<T>(
    ...
    public static ErrorResponse<Void> of(ErrorCode errorCode) {
        return new ErrorResponse<>(false, errorCode.getStatus().value(), errorCode.getCode(), errorCode.getMessage(),
    ...
    public static ErrorResponse<Void> of(ErrorCode errorCode, String message) {
        return new ErrorResponse<>(false, errorCode.getStatus().value(), errorCode.getCode(), message,
                LocalDateTime.now(), null);
    }
